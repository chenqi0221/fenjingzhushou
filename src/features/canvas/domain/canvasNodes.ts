...
export interface SmartStoryboardNodeData {
  displayName?: string;
  resultText: string;
  model: string;
  isGenerating?: boolean;
...
export interface ScriptMasterNodeData {
  displayName?: string;
  resultText: string;
  model: string;
  duration: string;
...
export type CanvasNodeData =
  ...
  | SmartStoryboardNodeData
  | ScriptMasterNodeData;
...
export function isSmartStoryboardNode(
  node: CanvasNode | null | undefined
): node is Node<SmartStoryboardNodeData, typeof CANVAS_NODE_TYPES.smartStoryboard> {
  return node?.type === CANVAS_NODE_TYPES.smartStoryboard;
}

export function isScriptMasterNode(
  node: CanvasNode | null | undefined
): node is Node<ScriptMasterNodeData, typeof CANVAS_NODE_TYPES.scriptMaster> {
  return node?.type === CANVAS_NODE_TYPES.scriptMaster;
}
