...
interface ModelParamsControlsProps {
  ...
  hideResolutionAndRatio?: boolean;
};
...
export const ModelParamsControls = memo(({
  ...
  const providerOptions = useMemo(() => {
    const providerOrder = ['volcano-vision', 'volcano', 'google'];
  ...
  return (
    <div ref={containerRef} className="flex items-center gap-1">
      ...
      {!hideResolutionAndRatio && resolutionOptions && selectedResolution && aspectRatioOptions && selectedAspectRatio && (
